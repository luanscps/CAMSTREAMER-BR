...
object WebControlHtml {
    ...
    fun build(): String {
        ...
        sb.append("const cid=crypto.randomUUID();")
        sb.append("setInterval(()=>fetch(`/api/heartbeat?cid=\${cid}`),5000);")
        sb.append("fetch(`/api/heartbeat?cid=\${cid}`);")
        // ─────────────────────────────────────────────────────────────────
        ...
        sb.append("}") // fecha if(hasFocus&&cap.supported_af_modes)
