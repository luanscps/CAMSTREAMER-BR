...
class LoginActivity : AppCompatActivity() {
     ...
     * Android menor que 12: usa WifiManager.connectionInfo (deprecated mas funcional)
     * Android 12+: itera NetworkInterface para pegar o IP real
     * Retorna null se sem Wi-Fi ou IP indisponivel.
     */
    private fun getLocalIpAddress(): String? {
        // Tenta via NetworkInterface (mais confiavel em Android 12+)
        try {
        ...
        // Fallback: WifiManager (Android menor que 12)
        return try {
