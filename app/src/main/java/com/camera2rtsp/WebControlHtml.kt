...
object WebControlHtml {
    ...
    fun build(): String {
        ...
        sb.append("--green:#10b981;--red:#ef4444;--yellow:#f59e0b;--purple:#a855f7;--orange:#fb923c;}")
        ...
        sb.append(".card.rggb-active{border-color:var(--orange)!important;")
        sb.append("box-shadow:0 0 0 2px rgba(251,146,60,.22)}")
        ...
        sb.append(".val.orange{color:var(--orange)}")
        ...
        sb.append("button.btn-orange{background:rgba(251,146,60,.12);border-color:var(--orange);color:var(--orange)}")
        sb.append("button.btn-orange:hover{background:var(--orange);color:#0f172a}")
        ...
        sb.append("input[type=range].orange-slider::-webkit-slider-thumb{background:var(--orange)}")
        ...
        // Monitor ao vivo — grid de métricas
        sb.append(".monitor-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px}")
        sb.append(".monitor-cell{background:var(--bg);border-radius:10px;padding:8px 10px;}")
        sb.append(".monitor-cell .mc-label{font-size:10px;color:var(--muted);text-transform:uppercase;letter-spacing:.05em}")
        sb.append(".monitor-cell .mc-val{font-size:15px;font-weight:800;color:var(--accent);margin-top:2px}")
        sb.append(".monitor-cell .mc-val.green{color:var(--green)}")
        sb.append(".monitor-cell .mc-val.yellow{color:var(--yellow)}")
        sb.append(".monitor-cell .mc-val.red{color:var(--red)}")
        sb.append(".monitor-cell .mc-val.orange{color:var(--orange)}")
        // RGGB sliders
        sb.append(".rggb-row{display:flex;align-items:center;gap:8px;margin-bottom:6px}")
        sb.append(".rggb-lbl{font-size:12px;font-weight:700;width:28px;flex-shrink:0}")
        sb.append(".rggb-lbl.r{color:#f87171}.rggb-lbl.gr{color:#4ade80}")
        sb.append(".rggb-lbl.gb{color:#34d399}.rggb-lbl.b{color:#60a5fa}")
        sb.append(".rggb-num{font-size:11px;font-weight:700;color:var(--orange);width:36px;text-align:right;flex-shrink:0}")
        sb.append(".rggb-slider{flex:1;}")
        ...
        sb.append("<div class=\"badge\" id=\"badge-rggb\" style=\"display:none\">\uD83C\uDF08 RGGB</div>")
        sb.append("</div>")
        ...
        // ── Monitor Ao Vivo ─────────────────────────────────────────────────
        sb.append("<div class=\"card\" id=\"card-monitor\">")
        sb.append("<h3>\uD83D\uDCCA Monitor Ao Vivo <span style=\"font-size:10px;color:var(--muted);font-weight:400\">(TotalCaptureResult)</span></h3>")
        sb.append("<div class=\"monitor-grid\">")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">ISO Real</div><div class=\"mc-val\" id=\"mon-iso\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">Shutter Real</div><div class=\"mc-val\" id=\"mon-shutter\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">AF State</div><div class=\"mc-val\" id=\"mon-af\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">AE State</div><div class=\"mc-val\" id=\"mon-ae\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">RGGB R (sensor)</div><div class=\"mc-val orange\" id=\"mon-rggb-r\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">RGGB B (sensor)</div><div class=\"mc-val orange\" id=\"mon-rggb-b\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">RGGB Gr</div><div class=\"mc-val\" id=\"mon-rggb-gr\">-</div></div>")
        sb.append("<div class=\"monitor-cell\"><div class=\"mc-label\">RGGB Gb</div><div class=\"mc-val\" id=\"mon-rggb-gb\">-</div></div>")
        sb.append("</div></div>")
        ...
        // ── Zoom Digital ────────────────────────────────────────────────────
        sb.append("<div class=\"card\" id=\"card-zoom\"><h3>\uD83D\uDD0D Zoom Digital <span class=\"val\" id=\"zoom-val\">1x</span></h3>")
        sb.append("<div class=\"slider-wrap\">")
        ...
        // ── Zoom Óptico ─────────────────────────────────────────────────────
        sb.append("<div class=\"card hidden\" id=\"card-optical-zoom\">")
        sb.append("<h3>\uD83D\uDD2D Zoom Óptico <span class=\"val orange\" id=\"optical-zoom-val\">Auto</span></h3>")
        sb.append("<p style=\"font-size:11px;color:var(--muted);margin-bottom:10px\">")
        sb.append("Troca a lente física (focal length). Sem perda de qualidade.</p>")
        sb.append("<div class=\"btngroup\" id=\"btngroup-optical-zoom\"></div>")
        sb.append("</div>")
        ...
        // ── WB Manual RGGB ───────────────────────────────────────────────────
        sb.append("<div class=\"card\" id=\"card-rggb\">")
        sb.append("<h3>\uD83C\uDF08 WB Manual RGGB <span class=\"val orange\" id=\"rggb-status\">Off</span></h3>")
        sb.append("<p style=\"font-size:11px;color:var(--muted);margin-bottom:12px\">")
        sb.append("Ganho por canal RGGB. Sobrescreve o AWB automatico quando ativo.</p>")
        // Slider R
        sb.append("<div class=\"rggb-row\">")
        sb.append("<span class=\"rggb-lbl r\">R</span>")
        sb.append("<input type=\"range\" class=\"rggb-slider orange-slider\" id=\"rggb-r\" min=\"10\" max=\"400\" value=\"100\" step=\"1\" oninput=\"updateRggb('R',this.value)\">")
        sb.append("<span class=\"rggb-num\" id=\"rggb-r-num\">1.00</span>")
        sb.append("</div>")
        // Slider Gr
        sb.append("<div class=\"rggb-row\">")
        sb.append("<span class=\"rggb-lbl gr\">Gr</span>")
        sb.append("<input type=\"range\" class=\"rggb-slider orange-slider\" id=\"rggb-gr\" min=\"10\" max=\"400\" value=\"100\" step=\"1\" oninput=\"updateRggb('Gr',this.value)\">")
        sb.append("<span class=\"rggb-num\" id=\"rggb-gr-num\">1.00</span>")
        sb.append("</div>")
        // Slider Gb
        sb.append("<div class=\"rggb-row\">")
        sb.append("<span class=\"rggb-lbl gb\">Gb</span>")
        sb.append("<input type=\"range\" class=\"rggb-slider orange-slider\" id=\"rggb-gb\" min=\"10\" max=\"400\" value=\"100\" step=\"1\" oninput=\"updateRggb('Gb',this.value)\">")
        sb.append("<span class=\"rggb-num\" id=\"rggb-gb-num\">1.00</span>")
        sb.append("</div>")
        // Slider B
        sb.append("<div class=\"rggb-row\">")
        sb.append("<span class=\"rggb-lbl b\">B</span>")
        sb.append("<input type=\"range\" class=\"rggb-slider orange-slider\" id=\"rggb-b\" min=\"10\" max=\"400\" value=\"100\" step=\"1\" oninput=\"updateRggb('B',this.value)\">")
        sb.append("<span class=\"rggb-num\" id=\"rggb-b-num\">1.00</span>")
        sb.append("</div>")
        // Presets RGGB
        sb.append("<div class=\"btngroup\" style=\"margin-top:10px\">")
        sb.append("<button onclick=\"applyRggbPreset(1.0,1.0,1.0,1.0)\" class=\"btn-orange\">Neutro</button>")
        sb.append("<button onclick=\"applyRggbPreset(1.8,1.0,1.0,1.4)\" class=\"btn-orange\">Quente</button>")
        sb.append("<button onclick=\"applyRggbPreset(1.2,1.0,1.0,2.0)\" class=\"btn-orange\">Frio</button>")
        sb.append("<button onclick=\"applyRggbPreset(2.0,1.0,1.0,1.0)\" class=\"btn-orange\">+Vermelho</button>")
        sb.append("<button onclick=\"applyRggbPreset(1.0,1.0,1.0,2.2)\" class=\"btn-orange\">+Azul</button>")
        sb.append("</div>")
        sb.append("<button style=\"width:100%;margin-top:8px\" class=\"btn-stop\" onclick=\"resetRggb(this)\">")
        sb.append("\u21BA Resetar RGGB (volta AWB Auto)</button>")
        sb.append("</div>")
        ...
        sb.append("var nm=document.getElementById(numId);if(nm)nm.textContent=v.toFixed(2);}")
        sb.append("setSlider('rggb-r','rggb-r-num',r);setSlider('rggb-gr','rggb-gr-num',gr);")
        sb.append("setSlider('rggb-gb','rggb-gb-num',gb);setSlider('rggb-b','rggb-b-num',b);")
        sb.append("_rggbEnabled=true;document.getElementById('card-rggb').classList.add('rggb-active');")
        sb.append("var badge=document.getElementById('badge-rggb');if(badge)badge.style.display='flex';")
        sb.append("var st=document.getElementById('rggb-status');if(st)st.textContent='Ativo';")
        sb.append("sendControl({rggbR:r,rggbGr:gr,rggbGb:gb,rggbB:b},null,'RGGB preset');}")
        sb.append("function resetRggb(btn){_rggbR=1;_rggbGr=1;_rggbGb=1;_rggbB=1;_rggbEnabled=false;")
        sb.append("['rggb-r','rggb-gr','rggb-gb','rggb-b'].forEach(function(id){var s=document.getElementById(id);if(s)s.value=100;});")
        sb.append("['rggb-r-num','rggb-gr-num','rggb-gb-num','rggb-b-num'].forEach(function(id){var n=document.getElementById(id);if(n)n.textContent='1.00';});")
        sb.append("document.getElementById('card-rggb').classList.remove('rggb-active');")
        sb.append("var badge=document.getElementById('badge-rggb');if(badge)badge.style.display='none';")
        sb.append("var st=document.getElementById('rggb-status');if(st)st.textContent='Off';")
        sb.append("sendControl({rggbReset:true},btn,'RGGB resetado / AWB Auto');}")
        // ── Zoom Óptico ──────────────────────────────────────────────────
        sb.append("function buildOpticalZoomButtons(focalLengths){")
        sb.append("var grp=document.getElementById('btngroup-optical-zoom');if(!grp)return;grp.innerHTML='';")
        sb.append("if(!focalLengths||focalLengths.length<=1){showCard('card-optical-zoom',false);return;}")
        sb.append("showCard('card-optical-zoom',true);")
        sb.append("for(var i=0;i<focalLengths.length;i++){(function(idx,fl){")
        sb.append("var b=document.createElement('button');b.className='btn-orange';")
        sb.append("b.textContent=fl.toFixed(1)+'mm';b.setAttribute('data-optz',idx);")
        sb.append("b.onclick=function(){markActive('data-optz',idx);")
        sb.append("document.getElementById('optical-zoom-val').textContent=fl.toFixed(1)+'mm';")
        ...
        sb.append("if(ozv)ozv.textContent=c.optical_zoom;")
        sb.append("if(c.optical_zoom_index)markActive('data-optz',c.optical_zoom_index);}")
        // RGGB badge sync
        sb.append("var rggbOn=c.rggb_enabled==='on';")
        sb.append("var badgeRggb=document.getElementById('badge-rggb');")
        sb.append("if(badgeRggb)badgeRggb.style.display=rggbOn?'flex':'none';")
        sb.append("var stRggb=document.getElementById('rggb-status');")
        ...
        sb.append("var aeState=c.live_ae_state||'-';")
        sb.append("var monIso=document.getElementById('mon-iso');if(monIso){monIso.textContent=liveIso==='0'?'-':liveIso;}")
        sb.append("var monSh=document.getElementById('mon-shutter');if(monSh)monSh.textContent=liveShutter;")
        sb.append("var monAf=document.getElementById('mon-af');if(monAf){monAf.textContent=afState;monAf.className='mc-val '+afClass(afState);}")
        sb.append("var monAe=document.getElementById('mon-ae');if(monAe){monAe.textContent=aeState;monAe.className='mc-val '+aeClass(aeState);}")
        sb.append("var monRr=document.getElementById('mon-rggb-r');if(monRr)monRr.textContent=c.live_rggb_r||'-';")
        sb.append("var monRb=document.getElementById('mon-rggb-b');if(monRb)monRb.textContent=c.live_rggb_b||'-';")
        sb.append("var monGr=document.getElementById('mon-rggb-gr');if(monGr)monGr.textContent=c.live_rggb_gr||'-';")
